...
public class Venda {
	...
	public Venda(int cod_v, int cliente_id, int produto_id, String cliente, String produto,
			BigDecimal vtotal, BigDecimal vpagamento, BigDecimal troco, String data,
			String hora) {
		this.id_v = cod_v;
	...
	public Venda(int cliente_id, int produto_id, String cliente,String produto,
			BigDecimal vtotal, BigDecimal vpagamento, BigDecimal troco, String data,
			String hora) {
		this.cliente_id = cliente_id;
	...
	public Venda(int cod_v, String cliente, String produto,
			BigDecimal vtotal, BigDecimal vpagamento,
